...
intro: "We invite short paper submissions on all topics listed below but not limited to them."

submission_format_title: "Submission Format"
submission_format:
  - "**Template:** We recommend using the [NeurIPS 2026 LaTeX template](https://neurips.cc/Conferences/2026/PaperInformation/StyleFiles)."
  - "**Main paper:** The main paper may be up to **5 pages**. References and the appendix **do not** count toward this limit."
  - "**Appendix:** An appendix may be included in the same PDF after the references."
  - "**Supplementary files:** We **do not** accept separate supplementary files."
  - "**Reviewer expectations:** The main paper should be self-contained. Reviewers **are not** required to read or consider material in the appendix."
  - "**Anonymity:** The entire submission, including the appendix, must comply with the workshop's double-blind review requirements."
